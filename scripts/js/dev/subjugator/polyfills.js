...
if (!Array.prototype.map) {
  ...
  polyfillsList += "Array.prototype.map";
	numPolyfillsLoaded++;
}
...
if (!Array.prototype.filter)
{
  ...
  polyfillsList += "Array.prototype.filter";
	numPolyfillsLoaded++;
}
...
if ( !Date.prototype.toISOString ) {
  ...
  polyfillsList += "Date.prototype.toISOString";
	numPolyfillsLoaded++;
}
...
(function() {
    ...
    polyfillsList += "window.requestAnimationFrame";
	  numPolyfillsLoaded++;
  }
    ...
    polyfillsList += "window.cancelAnimationFrame";
    numPolyfillsLoaded++;
  }
}());
...
if(numPolyfillsLoaded > 0){
  console.log("[%s]	Polyfills loaded: \"%s\"", new Date().toISOString(),polyfillsList.toString());
}
console.timeStamp("Loading Polyfills");
